...
$.fn.imagesLoaded = function(h) {
    var e = this,
        j = $.isFunction($.Deferred) ? $.Deferred() : 0,
        i = $.isFunction(j.notify),
            ...
            update: function(L) {
                ...
                if (typeof G.items[y] === "undefined") {} else {
                    ...
                    if (glarge.length == gthumbs.length && glarge.length > 0) {
                        ...
                        O.$details.find(".infosep, .og-grid-small").remove()
                    }
